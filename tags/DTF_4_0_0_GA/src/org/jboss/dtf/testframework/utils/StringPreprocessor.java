...
// UK.
//
// $Id: StringPreprocessor.java 170 2008-03-25 18:59:26Z jhalliday $
...
{
	private Hashtable    _replacements =  new Hashtable();
    ...
    public final void addReplacements(Hashtable t)
    {
     ...
     */
	public final void addReplacement(String text, String replace)
	{
    ...
    public final String preprocessParameters(String text)
    {
	...
	public final String[] preprocessParameters(String[] text, boolean eraseVars)
	{
		String[] returnValue = new String[text.length];

		for (int count=0;count<text.length;count++)
		{
			returnValue[count] = preprocessParameters(text[count], eraseVars);
		}
	 ...
	 */
    public String preprocessParameters(String text, boolean eraseVars)
    {
        return preprocessParameters(_replacements, text, eraseVars);
    }

    public String preprocessParameters(Hashtable sets, String text, boolean eraseVars)
	{
