...
import org.jboss.dtf.testframework.utils.InputStreamFileWriter;
...
public class JavaTaskRunner extends TaskRunner
{
    ...
    protected static boolean  DebugEnabled = Boolean.valueOf( System.getProperty(JAVA_TASK_RUNNER_DEBUG_PROPERTY, "true") ).booleanValue();
    ...
    {
        System.out.println(_proc+" Terminate Request - The task is "+(isRunning() ? "still running" : "no longer running - we have a problem!!!"));
    ...
    public final void runTask() throws Exception
    {
        try
        {
            ...
            System.out.println(_taskName+" _proc.getErrorStream() "+_proc);
            ...
            {
                System.out.println(_taskName+" _proc.getInputStream() "+_proc);
                    ...
                    while ( ( parseString = in.readLine() ) != null )
                    {
                        ...
                        if ( ( parseString.indexOf(_waitText) != -1 ) && ( ( _expectWaitForAnywhere) || ( parseString.indexOf(_waitText) == 0) ) )
                        {
                            ...
                            if (_passOnWaitFor)
                            {
                                 ...
                                 */
                            	System.out.println("TestNode: pass on wait for accepted") ;
                ...
                {
                    // Ignore it - the stream has been forcibly closed
                }
            ...
            else
            {
                try
                {
                    ...
                    try
                    {
                        if (_proc!=null)
                        {
                            System.out.println(_taskName+" _proc.exitValue() "+_proc);
                            _proc.exitValue();
                        }
            ...
            {
                System.out.println(_taskName+" Task still running - can't flag finished doing WaitFor");
                ...
                System.out.println(_taskName+" Task has completed - waitFor complete");
            }
            ...
            System.out.println(_taskName+" _proc = null");
            _proc = null;
        }
