 ...
 * UK.
 *
 * $Id: DownloadReport.java 170 2008-03-25 18:59:26Z jhalliday $
 */

import org.jboss.dtf.testframework.dtfweb.reportgen.ReportGenerator;
        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            if(archiveInfo != null)
            {
                ...
                org.jboss.dtf.testframework.testnode.RunUID runIds[] = archiveInfo.getRunIds();
                resp.setContentType("application/pdf");
                reportGen.generateReport(archiveInfo, new BufferedOutputStream(resp.getOutputStream()));
            }
        }
        catch(Exception e)
        {
