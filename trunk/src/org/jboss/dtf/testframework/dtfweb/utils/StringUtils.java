...
public class StringUtils
{
	public static String replaceString(String text, String find, String replace)
	{
		try
		{
			...
			{
				String start = text.substring(0,text.indexOf(find));
				String end = "";

				if (text.indexOf(find)+find.length()+1<text.length())
					end = text.substring(text.indexOf(find)+find.length());
